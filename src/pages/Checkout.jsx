...
const Checkout = () => {
  return (
    <div className="relative mx-auto px-5  w-full bg-gray-100 dark:bg-black-05">
            ...
            <form action="" className="mt-10 flex flex-col space-y-4">
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full rounded border-gray-300 bg-gray-50 dark:bg-black-01 py-3 px-4 text-sm  dark:placeholder-gray-300 outline-none  shadow-sm outline-none transition focus:ring-2 focus:ring-yellow-500 dark:text-gray-100"
                />
              </div>
                ...
                <div className="mr-6 flex flex-wrap">
                  <div className="my-1">
                    ...
                    <select
                      name="month"
                      id="month"
                      className="cursor-pointer rounded border-gray-300 bg-gray-50 dark:bg-black-01 py-3 px-2 text-sm shadow-sm outline-none transition focus:ring-2 dark:text-gray-300 focus:ring-yellow-500 dark:text-gray-100"
                    >
